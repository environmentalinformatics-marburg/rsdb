    ...
    <div class="main">
        ...
        <div style="text-align: center; padding-right: 400px;">
            <h3 class="headline mb-0">
                ...
                <v-btn class="indigo--text" v-if="meta !== undefined && meta.associated.rasterdb !== undefined" :href="$store.getters.apiUrl('web/app/#/?rasterdb=' + meta.associated.rasterdb)" target="_blank" title="open layer in viewer app on new tab">
        ...
        <div  v-if="meta != undefined">
            ...
            <div class="meta-content">
                ...
                <div style="padding-bottom: 10px;"><b>point attributes:</b><span v-for="name in meta.attributes" :key="name"><span class="attributes">{{name}}</span>&nbsp;&nbsp;&nbsp;</span></div>
            ...
            <v-divider class="meta-divider"></v-divider>  
            <h3 class="subheading mb-0"> 
                <admin-pointcloud-dialog-set-acl :meta="meta" @changed="refresh" v-if="meta.owner" />
                Access control
            </h3>                        
            <div class="meta-content">
                <table>
