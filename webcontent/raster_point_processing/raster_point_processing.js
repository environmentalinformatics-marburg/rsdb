...
var url_pointdb_raster = url_pointdb + '/raster';
  ...
  var rasterProcessingView = Vue.component('raster-processing-view', {
    ...
    methods: {
      ...
      onClickDownload: function () {
        ...
        var method = "unknown";
        var url = url_pointdb_raster + '.' + this.fileFormat;
        var parameters = { db: this.pointdb, ext: ext, format: this.fileFormat, type: this.raster_processing_type };
    ...
    computed: {
      raster_processing_types: function() {
        ...
        return this.meta.raster_processing_types.filter(function(t) {return self.valid_processing_types.indexOf(t.data_type) >= 0;});
      }
    },
