...
public class Fun_BE {
	...
	static class Fun_BE_PR_H extends ProcessingFun {
		...
		public Fun_BE_PR_H(int decile) {
			this(decile, "BE_PR_H" + (decile<=9 ? "0" : "") + decile, "Penetration rate (pass through rate) of "+((decile-1)*10)+"% to "+(decile*10)+"% height layer relative to maximum height (based on point height above ground)");
		}
		public Fun_BE_PR_H(int decile, String name, String descrption) {
