...
@Tag("point")
@Description("Ratio of area that is covered by LiDAR points (based on bounding box with aligned 1x1 meter grid, if no point is in one grid cell, cell is not covered) [bbox based]")
