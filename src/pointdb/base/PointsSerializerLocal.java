...
public final class PointsSerializerLocal extends Serializer<Point[]>{
	
	private PointsSerializerLocal(){}
	
	public static final Serializer<Point[]> DEFAULT = new PointsSerializerLocal();
